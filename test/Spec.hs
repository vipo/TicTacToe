...
bencode = testGroup "Bencode" [
    ...
    , QC.testProperty "array of maps with noise"    $ testArrayOfMaps   readBencode (noisy . renderBencode)
    , QC.testProperty "map of maps"                 $ testMapOfMaps     readBencode          renderBencode
    , QC.testProperty "map of maps with noise"      $ testMapOfMaps     readBencode (noisy . renderBencode)
    , QC.testProperty "arrays of arrays"            $ testArrayOfArrays readBencode          renderBencode
    , QC.testProperty "arrays of arrays with noise" $ testArrayOfArrays readBencode (noisy . renderBencode)
...
json = testGroup "Json" [
    ...
    , QC.testProperty "array of maps with noise"   $ testArrayOfMaps   readJson (noisy . renderJson)
    , QC.testProperty "map of maps"                $ testMapOfMaps     readJson          renderJson
    , QC.testProperty "map of maps with noise"     $ testMapOfMaps     readJson (noisy . renderJson)
    , QC.testProperty "arrays of arrays"           $ testArrayOfArrays readJson          renderJson
    , QC.testProperty "arrays of array with noise" $ testArrayOfArrays readJson (noisy . renderJson)
...
mexpr = testGroup "MExpr" [
    ...
    , QC.testProperty "array of maps with noise"    $ testArrayOfMaps   readMExpr (noisy . renderMExpr)
    , QC.testProperty "map of maps"                 $ testMapOfMaps     readMExpr          renderMExpr
    , QC.testProperty "map of maps with noise"      $ testMapOfMaps     readMExpr (noisy . renderMExpr)
    , QC.testProperty "arrays of arrays"            $ testArrayOfArrays readMExpr          renderMExpr
    , QC.testProperty "arrays of arrays with noise" $ testArrayOfArrays readMExpr (noisy . renderMExpr)
...
sexpr = testGroup "SExpr" [
    ...
    , QC.testProperty "array of maps with noise"    $ testArrayOfMaps   readSExpr (noisy . renderSExpr)
    , QC.testProperty "map of maps"                 $ testMapOfMaps     readSExpr          renderSExpr
    , QC.testProperty "map of maps with noise"      $ testMapOfMaps     readSExpr (noisy . renderSExpr)
    , QC.testProperty "arrays of arrays"            $ testArrayOfArrays readSExpr          renderSExpr
    , QC.testProperty "arrays of arrays with noise" $ testArrayOfArrays readSExpr (noisy . renderSExpr)
...
scala = testGroup "Scala" [
    ...
    , QC.testProperty "array of maps with noise"    $ testArrayOfMaps   readScala (noisy . renderScala)
    , QC.testProperty "map of maps"                 $ testMapOfMaps     readScala          renderScala
    , QC.testProperty "map of maps with noise"      $ testMapOfMaps     readScala (noisy . renderScala)
    , QC.testProperty "arrays of arrays"            $ testArrayOfArrays readScala          renderScala
    , QC.testProperty "arrays of arrays with noise" $ testArrayOfArrays readScala (noisy . renderScala)
...
noisy :: T.Text -> T.Text
noisy = whitespaceNoise $ cycle [0 .. 10]
